...
type Config struct {
	...
	CertificateStorePath   string   `envconfig:"EDG_DATAVAL_CERTIFICATE_STORE_PATH" required:"true"`
	AttestationProviderURL string   `envconfig:"EDG_DATAVAL_ATTESTATION_PROVIDER_URL" required:"true"`
}

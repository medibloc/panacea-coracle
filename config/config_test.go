...
func TestMustLoad(t *testing.T) {
	...
	t.Setenv("EDG_DATAVAL_CERTIFICATE_STORE_PATH", "my-certificate-store-path")
	...
	require.Equal(t, "my-certificate-store-path", c.CertificateStorePath)
	require.Equal(t, "my-attestation-provider-url", c.AttestationProviderURL)
}
